...
- **601+ automated tests** distributed across 57 files
...
- **Measurable coverage**: Built-in support for `flutter test --coverage`
...
- [x] Home screen widget tests (widget_service_test.dart)
- [ ] Deep link tests
- [ ] Data sharing tests
